...
class EnergyEnvContinuo(EnergyEnvBase):
    """
    Entorno con accion continua para control de bateria comunitaria.

    Hermano de EnergyEnvDiscreto: ambos heredan el andamiaje de EnergyEnvBase
    (misma observacion 108-dim, mismo reset(), misma logica AR(1), mismo split).
